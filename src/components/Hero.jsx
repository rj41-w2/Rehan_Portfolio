    ...
    <section id="home" className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden pt-32 pb-20 px-4">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between z-10">
        ...
        <div className="max-w-xl text-center lg:text-left lg:pr-8 space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 backdrop-blur-md text-slate-700 dark:text-slate-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 shadow-sm" style={{ fontSize: '0.7rem' }}>
            <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
            Hello, I'm {DATA.profile?.name || "Developer"}
          </div>

          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-slate-900 dark:text-white animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
            FUTURE <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-400 dark:to-cyan-400">ARCHITECT</span> <br />
          </h1>

          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            ...
            <TypeAnimation
              ...
              speed={50}
              repeat={Infinity}
              className="block mt-2 text-sm text-gray-500 dark:text-slate-500"
            />
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center pt-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <button
              ...
              className="px-8 py-4 bg-slate-900 text-white dark:bg-white dark:text-slate-900 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-blue-50 transition-all hover:scale-105 flex items-center gap-2 shadow-lg dark:shadow-none"
            >
            ...
            <Link
              ...
              className="px-8 py-4 bg-white/80 dark:bg-slate-800/50 text-slate-700 dark:text-white border border-slate-200 dark:border-slate-700 rounded-full font-medium hover:bg-gray-100 dark:hover:bg-slate-800 transition-all hover:border-gray-300 dark:hover:border-slate-500 backdrop-blur-sm"
            >
              Contact Me
            </Link>
          </div>
